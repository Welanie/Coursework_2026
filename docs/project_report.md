...
| Таблица | Назначение |
| --- | --- |
| `users` | Аккаунты, email, хеш пароля, роль, рейтинговые очки |
...
Для общего рейтинга у каждого пользователя есть стартовые 1000 очков. За правильный ответ начисляется 8 очков, за неправильный снимается 3 очка. Топ пользователей отображается на главной странице.
